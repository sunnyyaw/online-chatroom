...
CREATE TABLE `user_friend` (
  ...
  `confirm_second` tinyint(1) NOT NULL,
  PRIMARY KEY (`user_id_first`,`user_id_second`),
  KEY `user_id_second` (`user_id_second`),
  CONSTRAINT `user_friend_ibfk_1` FOREIGN KEY (`user_id_first`) REFERENCES `user` (`user_id`),
  CONSTRAINT `user_friend_ibfk_2` FOREIGN KEY (`user_id_second`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-03-25  0:43:29
